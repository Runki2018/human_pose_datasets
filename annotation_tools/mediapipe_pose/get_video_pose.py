...
if __name__ == '__main__':
    ...
    parser.add_argument('--file', '--file', '-f', type=str, help='The path of a video file or the root directory of video files..')
    ...
    if file.is_file():
        ...
        # 多个视频的根目录，提取到一个目录下
        if args.file != args.video_dir:
            extract_videos(videos_root=args.file, output_dir=args.video_dir)
